...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (hash) {
        ...
        if (oauthToken) {
            ...
            // Usa silencioso=true quando já estamos na agenda/config para evitar
            // que baixarBackupDrive redirecione de volta para tela-login.
            const _silenciosoBaixar = (origem === 'agenda' || origem === 'config') && estavLogado;
            console.log('[Drive] Iniciando download após OAuth...');
            const baixou = await baixarBackupDrive(_silenciosoBaixar);
